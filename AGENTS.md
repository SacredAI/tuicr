...
- **Input repainting**: The main loop coalesces non-key event bursts, repaints immediately after a new key press or paste, and drains repeat events together so held-key release is not stuck behind a backlog.
